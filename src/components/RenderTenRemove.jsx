 ...
 */
    ...
    return (
        ...
        <a href={profile.profileUrl} target="_blank" rel="noopener noreferrer" className="text-left">
        {profile.profileUrl}
        </a>
      </div>
        )
...
<div className="mt-10">
            {count < 10 ? (
        <button onClick={openAll} className="" title="CTRL+click to open links in a new tab">Open all</button>
      ) : (
        <div>
        ...
        <button onClick={resetCount} >OK</button>
            ...
            <button  className="mx-5 my-4 p-3 rounded-full bg-slate-200" type="submit">Save removed</button>
          </form>
